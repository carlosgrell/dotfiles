...
local lsp = {
  ...
  DiagnosticUnderlineError = { sp = C.red_2, undercurl = false, underline = false},
  DiagnosticUnderlineHint = { sp = C.red_2, undercurl = false, underline = false },
  DiagnosticUnderlineInfo = { sp = C.red_2, undercurl = false, underline = false },
  DiagnosticUnderlineWarn = { sp = C.red_2, undercurl = false, underline = false },
