...
map("n", "<leader>jj", "<cmd>:HopChar1<cr>", { desc = "Hop Char 1" })
map("n", "<leader>fy", "<cmd>:let @+ = expand('%')<cr><cmd>:echo expand('%')<cr>", { desc = "Yank file path" })
map("n", "<leader>fY", "<cmd>:let @+ = expand('%:p')<cr><cmd>:echo expand('%:p')<cr>", { desc = "Yank file absolute path" })
